...
namespace Heibe.Shooter
{
    ...
    public class HMoveComponent : HBaseComponent
	{
	    private HInputController mInput;
        ...
        private void Start()
        {
            ...
            mInput = Component<HInputController>();
            if (hcamera != null)
                cam = hcamera.EyeCamera;
            else
                cam = Camera.main;
        ...
        private void Update()
        {
            ...
            if (mInput.GetAxis("Jump") > 0 && !m_Jump)
            {
                m_Jump = true;
            }
        }
        ...
        private void FixedUpdate()
        {
            ...
            if ((Mathf.Abs(input.x) > float.Epsilon || Mathf.Abs(input.y) > float.Epsilon) && (airControl || m_IsGrounded))
            {
        ...
        private Vector2 GetInput()
        {
            ...
            Vector2 input = new Vector2
                {
                    x = mInput.GetAxis("Horizontal"),
                    y = mInput.GetAxis("Vertical")
                };
